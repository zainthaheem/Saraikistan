              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center p-7 text-cream sm:p-10 lg:p-14">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {featured.category && (
                      <span className="bg-mustard px-3 py-1 font-body text-[10px] uppercase tracking-[0.14em] text-navy">
                        {featured.category.title}
                      </span>
                    )}

                    {featured.publishedAt && (
                      <span className="font-body text-xs text-cream/55">
                      ...
                      >
                        ...
                        <div className="border-t-2 border-mustard p-6">
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            {item.category && (
                              <span className="font-body text-[10px] uppercase tracking-[0.14em] text-shawl">
                                {item.category.title}
                              </span>
                            )}

                            {item.publishedAt && (
                              <span className="font-body text-[10px] uppercase tracking-[0.12em] text-navy/40">
